...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MeteoCenter.showing_name'
        db.add_column('weather_meteocenter', 'showing_name',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MeteoCenter.showing_name'
        db.delete_column('weather_meteocenter', 'showing_name')
    ...
    models = {
        ...
        'weather.wdata': {
            ...
            'd_data_upd': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 5, 0, 0)'}),
        ...
        'weather.wlog': {
            ...
            'date_record': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 5, 0, 0)'}),
