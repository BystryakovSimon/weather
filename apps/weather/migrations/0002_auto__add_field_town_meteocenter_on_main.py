...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Town_MeteoCenter.on_main'
        db.add_column('weather_town_meteocenter', 'on_main',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Town_MeteoCenter.on_main'
        db.delete_column('weather_town_meteocenter', 'on_main')
